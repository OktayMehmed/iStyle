const products = [
  ...
  },
  {
    ...
    description:
      'Designed for those who defy limits and change the world, the 16-inch MacBook Pro is by far the most powerful notebook we have ever made.',
    price: 2799.99,
    countInStock: 5,
    rating: 3,
    numReviews: 12,
  ...
  },
  {
    ...
    description:
      'The future of health is on your wrist. Measure your blood oxygen level with a revolutionary sensor and app. Take an ECG anytime, anywhere.',
    price: 399.99,
    countInStock: 7,
    rating: 3.5,
    numReviews: 10,
  },
  {
    ...
    description:
      'The new Apple TV 4K brings the best of TV together with your favorite Apple devices and services — in a powerful experience that will transform your living room.',
    price: 199.99,
    countInStock: 0,
    rating: 4,
    numReviews: 12,
